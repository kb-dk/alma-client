...
//            marcRecord.addVariableField(dataField);
    ...
    public static DataField getDataField(Bib almaRecord, String tag) {
        try {
    ...
    public static String getSubfieldValue(Record marcRecord, String tag, Character subfield) {
        try {
    ...
    public static boolean isSubfieldPresent(Record marcRecord, String tag, Character subfield) {
        try {
            DataField df = (DataField) marcRecord.getVariableField(tag);
            df.getSubfield(subfield);
            return true;
        } catch (NullPointerException e) {
            log.info("SubField {} was not found", subfield);
            return false;
        }
    }
     ...
     */
    public static void getVariableField(Bib almaRecord, Record marcRecord, String tag) {
        try {
